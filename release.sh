...
$EDITOR resources/pallet_crate/forever_crate/meta.edn
$EDITOR doc-src/USAGE.md
git add resources/pallet_crate/forever_crate/meta.edn doc-src/USAGE.md doc-src/FOOTER.md \
